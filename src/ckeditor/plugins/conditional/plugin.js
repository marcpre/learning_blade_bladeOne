...
CKEDITOR.plugins.add( 'conditional', {
	...
	init: function( editor ) {
		...
		CKEDITOR.dialog.add( 'conditional', this.path + 'dialogs/conditional.js' );

		// Register the conditional widget.
		editor.widgets.add( 'conditional', {
			...
			allowedContent:
				'div(!conditional,align-left,align-right,align-center){width};' +
				'div(!conditional-content); h2(!conditional-title)',

			// Minimum HTML which is required by this widget to work.
			requiredContent: 'div(conditional)',

			// Define two nested editable areas.
			editables: {
				title: {
					// Define CSS selector used for finding the element inside widget element.
					selector: '.conditional-title',
			...
			template:
				'<div class="conditional">' +
					'<div class="conditional-if">Title</div>' +
					'<div class="condition">Condition</div>' +
					'<div class="conditional-content"><p>Content...</p></div>' +
					'<div class="conditional-elseif">Title</div>' +
					'<div class="condition">Condition</div>' +
					'<div class="conditional-content"><p>Content...</p></div>' +
					'<div class="conditional-endif">endif</div>' +
				'</div>',
			...
			// editor.lang.conditional.* property. A string was used directly here to simplify this tutorial.
			...
			upcast: function( element ) {
				...
				// for all <div> elements with a "conditional" class.
				return element.name == 'div' && element.hasClass( 'conditional' );
			},
			...
			data: function() {
				...
				// The style is set on widget main element (div.conditional).
				if ( this.data.width == '' )
